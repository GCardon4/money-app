...
export default defineConfig((/* ctx */) => {
  return {
    ...
    build: {
       env: {
        SUPABASE_URL: 'https://cyuyiinvnomyyrmhsmqo.supabase.co',
        SUPABASE_KEY: 'sb_publishable_MpKKhLqrELZtepOFIoLp9A_AuqHw8cT'
      },
    ...
    pwa: {
      ...
      // extendManifestJson para asegurar configuración correcta
